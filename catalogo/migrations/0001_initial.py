    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('altura', models.DecimalField(db_column='alutra', decimal_places=2, max_digits=10, verbose_name='Altura em cm')),
                ('largura', models.DecimalField(db_column='largura', decimal_places=2, max_digits=10, verbose_name='largura em cm')),
                ('comprimento', models.DecimalField(db_column='comprimeito', decimal_places=2, max_digits=10, verbose_name='comprimeito em cm')),
                ('slug', models.SlugField(max_length=100, verbose_name='Identificador')),
