    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('altura', models.DecimalField(db_column='alutra', decimal_places=3, max_digits=10, verbose_name='Altura')),
                ('largura', models.DecimalField(db_column='largura', decimal_places=3, max_digits=10, verbose_name='largura')),
                ('comprimento', models.DecimalField(db_column='comprimeito', decimal_places=3, max_digits=10, verbose_name='comprimeito')),
